    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform_number', models.CharField(db_index=True, help_text='WMO identifier of the float (e.g., 1901820)', max_length=8, unique=True)),
                ...
                ('data_centre_ref', models.CharField(help_text='Unique station identifier from the Data Centre', max_length=50, unique=True)),
            ],
            options={
